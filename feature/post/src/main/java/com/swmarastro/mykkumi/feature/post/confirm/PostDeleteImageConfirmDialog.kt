...
import com.swmarastro.mykkumi.feature.post.databinding.DialogPostDeleteImageConfirmBinding

class PostDeleteImageConfirmDialog(private val context: Fragment) {
